function createPitForm() {
    ...
    matchFocus.minWordsLimit = MAX_WRITTEN_WORDS;
    ...
    allyNeeds.minWordsLimit = MAX_WRITTEN_WORDS;
    ...
    sponsors.minWordsLimit = MAX_WRITTEN_WORDS;
